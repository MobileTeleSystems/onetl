...
class TestIntegrationONETLMySQL:
    ...
    def test_mysql_reader_connection_sql(self, spark, processing, prepare_schema_table, suffix):
        mysql = MySQL(
            host=processing.host,
            port=processing.port,
            user=processing.user,
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_fetch(self, spark, processing, prepare_schema_table, suffix):
        mysql = MySQL(
            host=processing.host,
            port=processing.port,
            user=processing.user,
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_execute_ddl(self, spark, processing, get_schema_table, suffix):
        mysql = MySQL(
            host=processing.host,
            port=processing.port,
            user=processing.user,
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_execute_dml(self, request, spark, processing, prepare_schema_table, suffix):
        mysql = MySQL(
            host=processing.host,
            port=processing.port,
            user=processing.user,
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_execute_procedure(self, request, spark, processing, prepare_schema_table, suffix):
        mysql = MySQL(
            host=processing.host,
            port=processing.port,
            user=processing.user,
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_execute_procedure_dml(self, request, spark, processing, get_schema_table, suffix):
        mysql = MySQL(
            host=processing.host,
            port=processing.port,
            user=processing.user,
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_execute_function(self, request, spark, processing, prepare_schema_table, suffix):
        mysql_root = MySQL(
            host=processing.host,
            port=processing.port,
            user="root",
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_execute_function_ddl(self, spark, processing, get_schema_table, suffix):
        mysql_root = MySQL(
            host=processing.host,
            port=processing.port,
            user="root",
    ...
    @pytest.mark.parametrize("suffix", ["", ";"])
    def test_mysql_reader_connection_execute_function_dml(self, request, spark, processing, get_schema_table, suffix):
        mysql_root = MySQL(
            host=processing.host,
            port=processing.port,
            user="root",
