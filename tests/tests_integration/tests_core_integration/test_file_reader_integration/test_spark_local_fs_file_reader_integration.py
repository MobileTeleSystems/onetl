"""Integration tests for FileReader, specific for SparkLocalFS.
...
def test_file_reader_run_with_empty_source_path(local_fs_file_df_connection_with_path, file_df_schema):
