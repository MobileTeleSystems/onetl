...
def test_mysql_reader_snapshot_with_columns_duplicated(spark, processing, prepare_schema_table):
    mysql = MySQL(
        host=processing.host,
        port=processing.port,
        user=processing.user,
...
def test_mysql_reader_snapshot_with_columns_mixed_naming(spark, processing, get_schema_table):
    mysql = MySQL(
        host=processing.host,
        port=processing.port,
        user=processing.user,
...
def test_mysql_reader_snapshot_nothing_to_read(spark, processing, prepare_schema_table):
    mysql = MySQL(
        host=processing.host,
        port=processing.port,
        user=processing.user,
