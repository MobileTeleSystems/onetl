...
def test_postgres_package():
    ...
    with pytest.warns(UserWarning, match=warning_msg):
        assert Postgres.package == "org.postgresql:postgresql:42.7.13"


@pytest.mark.parametrize(
    ("package_version", "expected_packages"),
    [
        (None, ["org.postgresql:postgresql:42.7.13"]),
        ("42.7.13", ["org.postgresql:postgresql:42.7.13"]),
        ("42.7.13-patch", ["org.postgresql:postgresql:42.7.13-patch"]),
