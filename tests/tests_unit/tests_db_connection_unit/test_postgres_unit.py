...
def test_postgres_package():
    ...
    with pytest.warns(UserWarning, match=warning_msg):
        assert Postgres.package == "org.postgresql:postgresql:42.7.11"


@pytest.mark.parametrize(
    ("package_version", "expected_packages"),
    [
        (None, ["org.postgresql:postgresql:42.7.11"]),
        ("42.7.11", ["org.postgresql:postgresql:42.7.11"]),
        ("42.7.11-patch", ["org.postgresql:postgresql:42.7.11-patch"]),
