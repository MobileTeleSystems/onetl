...
For writing data to Clickhouse, use [`DBWriter`](../../../db/db_writer.md#onetl.db.db_writer.db_writer.DBWriter).
...
### *pydantic model* onetl.connection.db_connection.clickhouse.options.ClickhouseWriteOptions

Spark JDBC writing options.

#### Versionadded
Added in version 0.5.0: Replace `Clickhouse.Options` → `Clickhouse.WriteOptions`
