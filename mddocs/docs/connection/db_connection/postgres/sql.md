# Reading from Postgres using `Postgres.sql` { #DBR-onetl-connection-db-connection-postgres-sql-reading-from-postgres-using-postgres-sql }
...
## Syntax support { #DBR-onetl-connection-db-connection-postgres-sql-syntax-support }
...
### Select only required columns { #DBR-onetl-connection-db-connection-postgres-sql-select-only-required-columns }
...
### Pay attention to `where` value { #DBR-onetl-connection-db-connection-postgres-sql-pay-attention-to-where-value }
...
## Options { #DBR-onetl-connection-db-connection-postgres-sql-options }
