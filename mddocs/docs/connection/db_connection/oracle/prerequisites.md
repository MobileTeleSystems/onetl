# Prerequisites { #DBR-onetl-connection-db-connection-oracle-prerequisites }
...
## Installing PySpark { #DBR-onetl-connection-db-connection-oracle-prerequisites-installing-pyspark }
...
## Connecting to Oracle { #DBR-onetl-connection-db-connection-oracle-prerequisites-connecting-to-oracle }

### Connection port { #DBR-onetl-connection-db-connection-oracle-prerequisites-connection-port }
...
### Connection host { #DBR-onetl-connection-db-connection-oracle-prerequisites-connection-host }
...
### Connect as proxy user { #DBR-onetl-connection-db-connection-oracle-prerequisites-connect-as-proxy-user }
...
### Required grants { #DBR-onetl-connection-db-connection-oracle-prerequisites-required-grants }
