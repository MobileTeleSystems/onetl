# Prerequisites { #DBR-onetl-connection-db-connection-mssql-prerequisites }
...
## Connecting to MSSQL { #DBR-onetl-connection-db-connection-mssql-prerequisites-connecting-to-mssql }

### Connection port { #DBR-onetl-connection-db-connection-mssql-prerequisites-connection-port }
...
### Connection host { #DBR-onetl-connection-db-connection-mssql-prerequisites-connection-host }
...
### Required grants { #DBR-onetl-connection-db-connection-mssql-prerequisites-required-grants }
