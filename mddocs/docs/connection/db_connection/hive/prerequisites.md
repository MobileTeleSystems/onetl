# Prerequisites { #DBR-onetl-connection-db-connection-hive-prerequisites }
...
## Installing PySpark { #DBR-onetl-connection-db-connection-hive-prerequisites-installing-pyspark }
...
## Connecting to Hive Metastore { #DBR-onetl-connection-db-connection-hive-prerequisites-connecting-to-hive-metastore }
...
## Using Kerberos { #DBR-onetl-connection-db-connection-hive-prerequisites-using-kerberos }

Some of Hadoop managed clusters use Kerberos authentication. In this case, you should call [kinit](https://web.mit.edu/kerberos/krb5-1.12/doc/user/user_commands/kinit.html) command **BEFORE** starting Spark session to generate Kerberos ticket. See [Kerberos installation][DBR-onetl-install-kerberos-support].
