# Writing to Hive using `DBWriter` { #DBR-onetl-connection-db-connection-hive-write-writing-to-hive-using-dbwriter }

For writing data to Hive, use [DBWriter][DBR-onetl-db-writer].

## Examples { #DBR-onetl-connection-db-connection-hive-write-examples }
...
## Recommendations { #DBR-onetl-connection-db-connection-hive-write-recommendations }

### Use column-based write formats { #DBR-onetl-connection-db-connection-hive-write-use-column-based-write-formats }
...
### Use partitioning { #DBR-onetl-connection-db-connection-hive-write-use-partitioning }

#### How does it work { #DBR-onetl-connection-db-connection-hive-write-how-does-it-work }
...
#### But why? { #DBR-onetl-connection-db-connection-hive-write-but-why }
...
#### Which columns should I use? { #DBR-onetl-connection-db-connection-hive-write-which-columns-should-i-use }
...
### Use compression { #DBR-onetl-connection-db-connection-hive-write-use-compression }

Using compression algorithms like `snappy`, `lz4` or `zstd` can reduce the size of files (up to 10x).

### Prefer creating large files { #DBR-onetl-connection-db-connection-hive-write-prefer-creating-large-files }
...
### Sort data before writing { #DBR-onetl-connection-db-connection-hive-write-sort-data-before-writing }
