# Writing to Kafka { #DBR-onetl-connection-db-connection-kafka-write-writing-to-kafka }

For writing data to Kafka, use [DBWriter][DBR-onetl-db-writer] with specific options (see below).

## Dataframe schema { #DBR-onetl-connection-db-connection-kafka-write-dataframe-schema }
...
## Value serialization { #DBR-onetl-connection-db-connection-kafka-write-value-serialization }
...
## Examples { #DBR-onetl-connection-db-connection-kafka-write-examples }
