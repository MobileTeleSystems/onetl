...
| `time(3)`, milliseconds             |                                                                                                                                  |                                                                            |                                                                        |
| `time(6)`, microseconds             | `TimestampType()`, microseconds,<br/>with time format quirks <sup>[5](#id16)</sup>                                               | `datetime2(6)`, microseconds                                               | `datetime`, milliseconds,<br/>**precision loss** <sup>[3](#id14)</sup> |
|                                     |                                                                                                                                  |                                                                            |                                                                        |
