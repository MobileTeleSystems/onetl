...
## What are hooks? { #DBR-onetl-hooks-design-what-are-hooks }
...
### Features { #DBR-onetl-hooks-design-features }
...
Hooks can be placed into [`plugins`][DBR-onetl-plugins], allowing to modify onETL behavior by installing some additional package.
...
### TL;DR { #DBR-onetl-hooks-design-tldr }
...
#### Define a slot { #DBR-onetl-hooks-design-define-a-slot }
...
#### Define a callback { #DBR-onetl-hooks-design-define-a-callback }
...
#### Bind hook to the slot { #DBR-onetl-hooks-design-bind-hook-to-the-slot }
...
## How hooks are called? { #DBR-onetl-hooks-design-how-hooks-are-called }

### General { #DBR-onetl-hooks-design-general }
...
### Context managers { #DBR-onetl-hooks-design-context-managers }
...
### Generator function { #DBR-onetl-hooks-design-generator-function }
...
### Calling hooks in details { #DBR-onetl-hooks-design-calling-hooks-in-details }
...
### Hooks priority { #DBR-onetl-hooks-design-hooks-priority }
...
### Hook types { #DBR-onetl-hooks-design-hook-types }
...
#### Before hook { #DBR-onetl-hooks-design-before-hook }
...
#### After hook { #DBR-onetl-hooks-design-after-hook }
...
#### Context hook { #DBR-onetl-hooks-design-context-hook }
...
#### Replacing result hook { #DBR-onetl-hooks-design-replacing-result-hook }
...
See [`hive`][DBR-onetl-connection-db-connection-hive] and [`hdfs`][DBR-onetl-connection-file-connection-hdfs] as an example.
...
#### Accessing result hook { #DBR-onetl-hooks-design-accessing-result-hook }
...
#### Modifying result hook { #DBR-onetl-hooks-design-modifying-result-hook }
...
## How to enable/disable hooks? { #DBR-onetl-hooks-design-how-to-enabledisable-hooks }
...
## How to see logs of the hook mechanism? { #DBR-onetl-hooks-design-how-to-see-logs-of-the-hook-mechanism }
