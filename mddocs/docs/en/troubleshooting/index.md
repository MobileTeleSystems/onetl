...
- Read the logs or exception messages you've faced with.
    - If Python logs are note verbose enough, [increase the log level][logging].
    - If Spark logs are note verbose enough, [increase the log level][troubleshooting-spark].
