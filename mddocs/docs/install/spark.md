...
## Injecting Java packages { #DBR-onetl-install-spark-injecting-java-packages }
...
### Using `spark.jars` { #DBR-onetl-install-spark-using-spark-jars }
...
### Using `spark.jars.repositories` { #DBR-onetl-install-spark-using-spark-jars-repositories }
...
### Using `spark.jars.ivySettings` { #DBR-onetl-install-spark-using-spark-jars-ivysettings }
...
### Place `.jar` file to `~/.ivy2/jars/` { #DBR-onetl-install-spark-place-jar-file-to-ivy2jars }
...
### Place `.jar` file to Spark jars folder { #DBR-onetl-install-spark-place-jar-file-to-spark-jars-folder }
...
### Manually adding `.jar` files to `CLASSPATH` { #DBR-onetl-install-spark-manually-adding-jar-files-to-classpath }
