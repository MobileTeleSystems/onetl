...
Если конкретный модуль/класс/функция использует некоторые возможности регистрации onETL, например [`hook-decorator`](../hooks/hook.html#hook-decorator), он будет выполнен во время этого импорта.
