    ...
    def get_packages(
        ...
        *,
        ...
        if scala_version:
            ...
            if spark_ver.digits(2) < (2, 3):
                # There is no package for Spark 2.2 and lower
                raise ValueError(f"Spark version must be at least 2.3, got {spark_ver}")
        ...
        if scala_ver.digits(2) < (2, 11):
            raise ValueError(f"Scala version must be at least 2.11, got {scala_ver}")
