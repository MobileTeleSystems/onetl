...
class SparkS3(SparkFileDFConnection):
    """
    Spark connection to S3 filesystem. [![support hooks](https://img.shields.io/badge/%20-support%20hooks-blue)][DBR-onetl-hooks]
    ...
    === "Create S3 connection with bucket as subdomain (`my-bucket.domain.com`):"
        ...
        maven_packages = SparkS3.get_packages()
    ...
    def close(self) -> Self:
        """
        Close all connections created to S3. [![support hooks](https://img.shields.io/badge/%20-support%20hooks-blue)][DBR-onetl-hooks]
